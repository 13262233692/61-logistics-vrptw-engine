...
const (
	TempZoneFrozen  = "frozen"
	TempZoneChilled = "chilled"
)
...
type Vehicle struct {
	...
	CapFrozen  float64 `json:"cap_frozen"`
	CapChilled float64 `json:"cap_chilled"`
...
type RouteResult struct {
	...
	LoadFrozen  float64 `json:"load_frozen"`
	LoadChilled float64 `json:"load_chilled"`
}
